  ...
  Widget build(BuildContext context) {
    ...
    if (widget.template.needMeasure) {
      ...
      if (templateInfo.templateType == 'DataLabel' &&
          widget.chart is SfCartesianChart) {
        final dynamic seriesRenderer = widget.chart._chartSeries
        ...
        if (point != null) {
          if (point.region == null) {
            seriesRenderer.calculateRegionData(widget.chart, seriesRenderer, 0,
                point, templateInfo.pointIndex, null, null, null, null);
          }
