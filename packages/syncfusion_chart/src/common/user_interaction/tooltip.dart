...
class TooltipBehavior extends ChartBehavior {
  TooltipBehavior({TextStyle textStyle,
  ...
  //TODO: KHOA CUSTOM
  final Function(String header, String description, String value) customValueStringBuilder;
  final Function(String header, String description, String value) customHeaderStringBuilder;
