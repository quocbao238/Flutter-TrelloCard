...
class _PyramidChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    seriesRenderer = chart._chartSeries.visibleSeriesRenderers[seriesIndex];
...
class PyramidSeriesController {
  ...
  void _updateSeries() {
    final SfPyramidChart chart = seriesRenderer._pyramidChart;
    chart._chartSeries._processDataPoints();
